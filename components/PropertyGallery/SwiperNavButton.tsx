...
export const SwiperNavButtons = () => {
  ...
  return (
    <>
      ...
      >
        <FaArrowCircleLeft className="text-grey text-2xl lg:text-4xl hover:text-dark_yellow" />
      </button>
      <button
        onClick={() => swiper.slideNext()}
        className="flex justify-center items-center  absolute right-0 sm:-right-10 top-1/2 z-10"
      >
        <FaArrowCircleRight className="text-grey text-2xl lg:text-4xl hover:text-dark_yellow" />
      </button>
    </>
  );
};
