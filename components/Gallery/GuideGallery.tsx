...
function GuideGallery({ initIndex }: Props) {
  ...
  const totalImages = TouristImageData.length;
      ...
      <div className="mx-auto w-full">
        ...
        <div className="h-screen flex items-center justify-center">
          <div className="w-screen m-auto landscape:m-0 relative">
            ...
            <button className="guide-prev h-full absolute block top-0 text-4xl left-0 z-40">
              <div className="bg-grey2 sm:p-1 rounded-r-md sm:opacity-100 opacity-30">
                <IoIosArrowRoundBack className="text-black" />
              </div>
            </button>
            <button className="guide-next h-full block absolute right-0 top-0 text-4xl z-10">
