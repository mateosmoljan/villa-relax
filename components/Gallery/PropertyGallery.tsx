    ...
    <section className="Photo">
      <div className="container py-10 relative">
        ...
        <AppContext.Provider value={{ openIndex, setOpenIndex }}>
          <div className="w-full flex flex-col sm:flex-row gap-3 h-96 ">
            ...
            <div className="pt-5 flex justify-end absolute right-2 container bottom-12">
              <button
                onClick={() => setOpenIndex(true)}
                className="btn-2 flex gap-2 !bg-grey2 !text-dark_blue_black font-Bold"
              >
                <TfiGallery />
