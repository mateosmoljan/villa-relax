  ...
  return (
    <section className="flex justify-center">
      <div className="sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl p-3 py-20">
        <div className="flex justify-between gap-2 sm:items-center sm:flex-row flex-col w-full shadow-2xl p-10 lg:gap-12">
          <div>
          ...
          <div className="sm:block flex justify-end ">
            <button className="btn w-36">Send Message</button>
          </div>
        </div>
      </div>
    </section>
